#!/bin/bash
# 커뮤니티 여론(FOMO) 갱신 런처 (launchd에서 2시간마다 호출).
#
...
#
# 원본은 /Users/huisang/Documents/peer/scripts/fomo_update.sh 이고, 이 런처는
# 홈 밖에 복제된 사본을 호출한다.
exec /bin/bash /Users/huisang/.peer-cron/fomo_update.sh
